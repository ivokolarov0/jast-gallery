...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![greet, password_check, crate::db::save_game_if_missing, crate::db::is_game_synced, crate::db::bulk_is_game_synced, crate::db::search_games_by_tags, crate::db::search_db_games, crate::db::list_db_tags, crate::db::search_db_games_paged])
